...
if __name__ == '__main__':
    ...
    # for an example, we aggregate the sales of every product of every store,
    #here is the real 'fucntion'
    #sales_df = pd.read_csv(sales_path).T
    
    #here are the changes for the example
    sales_df=pd.read_csv(sales_path).groupby(by='item_id').sum().T
